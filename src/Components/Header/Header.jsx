      ...
      <nav>
        ...
        <span className="pl-5 flex flex-col-2">
          ...
          <div className="flex justify-center py-4 uppercase">
            <div>
            <a href=""><svg class="w-6 h-6 text-gray-800 dark:text-pink-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 19 20">
            ...
            <div className="px-4">
            <a href="" className="px-4 py-2 bg-pink-400 rounded-md hover:bg-white border-2 border-pink-400">login</a>
            </div>
            <div>
            <a href="" className="px-4 py-2 bg-black rounded-md hover:bg-white border-2 border-black hover:text-black text-white">sign-up</a>
            </div>
          </div>
        </div>
      </nav>
